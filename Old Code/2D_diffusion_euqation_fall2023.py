# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 11:00:56 2023
...
fig1 = plt.figure()
ax1 = fig1.add_subplot(111, projection='3d')  # Use add_subplot to create a 3D axis
...
ax2 = fig2.add_subplot(111)  # Use add_subplot for 2D axis
disp = plt.imshow(u[:])
ax2.set_xlabel('$x$')
ax2.set_ylabel('$y$')
